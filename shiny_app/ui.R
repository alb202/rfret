            ...
            tabsetPanel(id="main",
                        ...
                        tabPanel(title = "Inspect Raw Data", value = "inspect",
                                 wellPanel(
                                     ...
                                     fluidRow(
                                         column(width = 6, offset = 0,# height = 30,
                                                #column(width = 1, offset = 0,imageOutput("decision_image", width = 30, height = 30), align="center"),
                                                column(width = 12, offset = 0, align="left", p(textOutput("filename"), style='padding:0px;text-align:center;align-content:left;'))),
                                         column(width = 3, offset = 0,
                                                column(width = 6, offset = 0, disabled(actionButton(inputId = "accept",
                                                                                                    label="Accept",
                                                                                                    width = '130%', style='padding:1px;text-align:center'))),
                                                column(width = 6, offset = 0, disabled(actionButton(inputId = "reject",
                                                                                                    label="Reject",
                                                                                                    width = '130%', style='padding:1px;text-align:center')))),
                                         column(width = 3, offset = 0,
